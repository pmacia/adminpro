...
export class UsuariosComponent implements OnInit {
  ...
  mostrarModal( id: string ) {
    this.modalUploadService.motrarModal( 'usuarios', id );
  }
  ...
  borrarUsuario( usuario: Usuario ) {
    ...
    swalWithBootstrapButtons.fire({
      title: '¿Está seguro?',
      text: `Está a punto de eliminar al usuaurio: ${usuario.nombre}. El borrado es irreversible`,
      type: 'warning',
  ...
  guardarUsuario( usuario: Usuario ) {
    ...
    swalWithBootstrapButtons.fire({
      title: '¿Está seguro?',
      text: `Está a punto de modificar la información del usuaurio: ${usuario.nombre}. El cambio es irreversible`,
      type: 'warning',
      showCancelButton: true,
